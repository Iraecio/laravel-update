...
return [
    ...
    */
    ...
    'notifications' => [
        'notifications' => [
            \Iraecio\Updater\Notifications\Notifications\UpdateSucceeded::class => ['mail'],
            \Iraecio\Updater\Notifications\Notifications\UpdateFailed::class    => ['mail'],
            \Iraecio\Updater\Notifications\Notifications\UpdateAvailable::class => ['mail'],
        ],
         ...
         */
        'notifiable' => \Iraecio\Updater\Notifications\Notifiable::class,
